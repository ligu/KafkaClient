...
namespace KafkaClient.Tests
{
    ...
    {
        private readonly KafkaOptions _options = new KafkaOptions(TestConfig.IntegrationUri, log: TestConfig.DebugLog);
            ...
            using (var router = new Router(_options)) {
                await router.TemporaryTopicAsync(async topicName => {
                    ...
                    using (var producer = new Producer(router, new ProducerConfiguration(batchSize: numberOfMessages))) {
                        ...
                        TestConfig.InfoLog.Info(() => LogEvent.Create(">> Start Produce"));
                        ...
                        TestConfig.InfoLog.Info(() => LogEvent.Create(">> End Produce"));
                    }
