...
namespace KafkaClient.Tests.Unit
{
    ...
    public class BrokerRouterTests
    {
        ...
        public void Setup()
        {
            ...
            _mockKafkaConnectionFactory.Setup(x => x.Create(It.Is<KafkaEndpoint>(e => e.Endpoint.Port == 1), It.IsAny<TimeSpan>(), It.IsAny<IKafkaLog>(), It.IsAny<int>(), It.IsAny<TimeSpan?>(), It.IsAny<bool>())).Returns(() => _mockKafkaConnection1.Object);
