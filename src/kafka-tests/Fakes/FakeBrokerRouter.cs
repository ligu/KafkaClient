...
namespace kafka_tests
{
    public class FakeBrokerRouter
    {
        ...
        public FakeBrokerRouter()
        {
            ...
            _mockKafkaConnectionFactory.Create(Arg.Is<KafkaEndpoint>(e => e.Endpoint.Port == 1), Arg.Any<TimeSpan>(), Arg.Any<IKafkaLog>(), Arg.Any<int>()).Returns(_fakeConn0);
            _mockKafkaConnectionFactory.Create(Arg.Is<KafkaEndpoint>(e => e.Endpoint.Port == 2), Arg.Any<TimeSpan>(), Arg.Any<IKafkaLog>(), Arg.Any<int>()).Returns(_fakeConn1);
