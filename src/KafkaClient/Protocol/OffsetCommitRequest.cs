...
namespace KafkaClient.Protocol
{
    ...
    {
        public OffsetCommitRequest(string groupId, IEnumerable<OffsetCommit> offsetCommits, string memberId = null, int groupGenerationId = -1, TimeSpan? offsetRetention = null) 
